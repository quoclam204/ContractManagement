...
public class ContractsController : ControllerBase
{
        ...
        [FromQuery] int pageSize = 10)
    {
        ...
        var contracts = await query
            ...
            .Select(c => new ContractListItemResponseDto
            {
                ...
                PartnerName = "Đối tác " + c.PartnerId.ToString().Substring(0, 8), // Sau này Người 3 sẽ join tên đối tác
                Value = c.Value,
    ...
    public async Task<ActionResult<ContractDetailResponseDto>> CreateDraft([FromBody] CreateContractDraftRequest request)
    {
        ...
        else
        {
            ...
            {
                // Nếu loại hợp đồng này chưa có template nào, tự tạo 1 template version 1 mặc định
        ...
        var contract = new Contract
        {
            ...
            Status = ContractStatus.Draft, // Bắt buộc khởi tạo là Draft
    ...
    public async Task<IActionResult> UpdateDraft(Guid id, [FromBody] UpdateContractDraftRequest request)
    {
        ...
        // QUY TẮC AN TOÀN SỐ 4: BẮT BUỘC KIỂM TRA TRẠNG THÁI
    ...
    public async Task<IActionResult> SubmitForApproval(Guid id)
    {
        ...
        try
        {
            // Sử dụng State Machine domain method đã được bảo vệ chặt chẽ
    ...
    private async Task<Guid> EnsurePartnerIdAsync(Guid? requestedPartnerId)
    {
        ...
        // Nếu bảng PARTNERS trống, tự động tạo 1 Đối tác mẫu
